                                ...
                                <td colspan="6">
                                    <div class="nested-card supplier-nested-card supplier-accordion-card">
                                        ...
                                        <div class="supplier-accordion-grid supplier-accordion-body">
                                            <div><?= e(($supplier['nhom_zalo'] ?? '') !== '' ? $supplier['nhom_zalo'] : 'Chưa cập nhật') ?></div>
                                            <div><?= e(($supplier['san_pham_ncc'] ?? '') !== '' ? $supplier['san_pham_ncc'] : 'Chưa cập nhật') ?></div>
                                            <div><?= e(($supplier['thuong_hieu_phan_phoi'] ?? '') !== '' ? $supplier['thuong_hieu_phan_phoi'] : 'Chưa cập nhật') ?></div>
                                            <div><?= e(($supplier['san_pham_chi_tiet'] ?? '') !== '' ? $supplier['san_pham_chi_tiet'] : 'Chưa cập nhật') ?></div>
                                            <div><?= e(($supplier['ghi_chu'] ?? '') !== '' ? $supplier['ghi_chu'] : 'Không có') ?></div>
                                            <div></div>
                                        </div>
                                    </div>
                                </td>
                    ...
                    <article class="mobile-card supplier-mobile-card">
                        ...
                        <div class="mobile-card-grid">
                            ...
                            <div class="mobile-field">
                                ...
                                <span class="mobile-field-value"><?= e(($supplier['nguoi_lien_he'] ?? '') !== '' ? $supplier['nguoi_lien_he'] : 'Chưa cập nhật') ?></span>
                            </div>
                            <div class="mobile-field">
                        ...
                        <div id="supplier-mobile-<?= e((string) $index) ?>" class="mobile-card-detail" data-collapse-item="supplier-mobile" hidden>
                            <div class="mobile-detail-list">
                                <div class="mobile-detail-block">
                                    ...
                                    <?= e(($supplier['nhom_zalo'] ?? '') !== '' ? $supplier['nhom_zalo'] : 'Chưa cập nhật') ?>
                                </div>
                                <div class="mobile-detail-block">
                                    <strong>Sản phẩm NCC</strong>
                                    <?= e(($supplier['san_pham_ncc'] ?? '') !== '' ? $supplier['san_pham_ncc'] : 'Chưa cập nhật') ?>
                                </div>
                                <div class="mobile-detail-block">
                                    <strong>Thương hiệu phân phối</strong>
                                    <?= e(($supplier['thuong_hieu_phan_phoi'] ?? '') !== '' ? $supplier['thuong_hieu_phan_phoi'] : 'Chưa cập nhật') ?>
                                </div>
                                <div class="mobile-detail-block">
                                    <strong>Sản phẩm chi tiết</strong>
                                    <?= e(($supplier['san_pham_chi_tiet'] ?? '') !== '' ? $supplier['san_pham_chi_tiet'] : 'Chưa cập nhật') ?>
                                </div>
                                <div class="mobile-detail-block">
                                    <strong>Ghi chú</strong>
                                    <?= e(($supplier['ghi_chu'] ?? '') !== '' ? $supplier['ghi_chu'] : 'Không có') ?>
                                </div>
                            </div>
                        </div>
                    </article>
