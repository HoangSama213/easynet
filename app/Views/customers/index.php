<section class="card">
    <form method="GET" action="<?= e(base_url('khach-hang')) ?>" class="search-panel">
        <div class="search-row">
            <input
                ...
                name="keyword"
                value="<?= e($keyword ?? '') ?>"
                placeholder="Tìm kiếm phân loại, nhóm khách hàng, khách hàng tiêu biểu...">
...
<section class="card" style="margin-top: 18px;">
    <div class="stack section-head">
        <h3 style="margin: 0;">Quản lý khách hàng</h3>
        <div class="stack">
            <span class="badge"><?= e((string) ($pagination['total'] ?? 0)) ?> phân loại</span>
            ...
            <table class="customer-table">
                ...
                <tbody>
                    ...
                    <tr id="customer-row-<?= e((string) $index) ?>" class="detail-row" data-collapse-item="customer-desktop" hidden>
                        <td colspan="2">
                            <div class="nested-card customer-nested-card">
                                <div class="table-wrap">
                                    <table>
                                        <thead>
                                            <tr>
