<section class="card">
    <form method="GET" action="<?= e(base_url('doi-tac')) ?>" class="search-panel">
        <div class="search-row">
            <input
                ...
                name="keyword"
                value="<?= e($keyword ?? '') ?>"
                placeholder="Tìm kiếm lĩnh vực, đối tác tiêu biểu...">
...
<section class="card" style="margin-top: 18px;">
    <div class="stack section-head">
        <h3 style="margin: 0;">Quản lý đối tác</h3>
        <div class="stack">
            <span class="badge"><?= e((string) ($pagination['total'] ?? 0)) ?> lĩnh vực</span>
            ...
            <table class="partner-table">
                ...
                <tbody>
                    ...
                    <tr id="partner-row-<?= e((string) $index) ?>" class="detail-row" data-collapse-item="partner-desktop" hidden>
                        <td colspan="2">
                            <div class="nested-card partner-nested-card">
                                <div class="table-wrap">
                                    <table>
                                        <thead>
                                            <tr>
